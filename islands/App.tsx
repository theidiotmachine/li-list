      ...
      <AppState.Provider value={state}>
        <div class="flex flex-col">
          <div class="flex flex-row fixed z-50 w-full gap-0 bg-blue-50">
            ...
            <ArmyHeader localuuid={props.localuuid} clouduuid={props.clouduuid} isLoggedIn={props.isLoggedIn} username={props.username} class="md:flex-none flex-grow"/>
            <div class="grow md:min-w-8 bg-white"></div>
          </div>

          {(props.localuuid != "" || props.clouduuid != "")
            ? <ArmyWidget localuuid={props.localuuid} clouduuid={props.clouduuid} isLoggedIn={props.isLoggedIn} username={props.username} class="mt-40 md:mt-32 relative"/>
            : <HelloWidget/>
          }
          </div>
      </AppState.Provider>
