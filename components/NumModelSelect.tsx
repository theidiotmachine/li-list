...
export function NumModelSelect(props: NumModelSelectProps) {
    ...
    return <select class = "w-10 appearance-none" onInput={(e) => changeModelNumber(props.uuid, props.detachmentIndex, props.modelType, parseNumber(e.currentTarget.value, ""))}>
